...
# Word variabes
topics = ["dance", "finance", "vegetables", "cars"]
...
words = {"dance": ['ACROBATIC', 'ADAGIO', 'AFFECT', 'ALLEMANDE', 'APPRECIATION', 'ART', 'ARTISTIC', 'ATTRIBUTE', 'AUDIENCE', 'AUTHENTIC', 'BALLET', 'BALLROOM', 'BAND', 'BARRE', 'BEARING', 'BEAUTY', 'BEGUINE', 'BLEND', 'BODY', 'BOLERO', 'BOP', 'BORN TO', 'BOW', 'BUFF', 'BUNNY HOP', 'CAKEWALK', 'CANCAN', 'CELEBRATION', 'CHARACTERISTIC', 'CHARLESTON', 'CHOREOGRAPHY', 'CLASSES', 'CLASSICAL', 'CLOCKWISE', 'CLOG', 'COLLABORATIVE', 'COMMUNICATION', 'COMPETENT', 'COMPLEX', 'COMPOSITION', 'CONGA', 'COSTUMES', 'COTILLION', 'CRAFT', 'CULTURAL', 'CULTURE', 'CURTSY', 'DECOR', 'DELICATE', 'DESCRIPTION', 'DESIGN', 'DEVELOP', 'DEVOTION', 'DIP', 'DIRECTION', 'DIRECTOR', 'DISCO', 'EFFECT', 'EFFECTIVE', 'EFFORT', 'EFFORTLESS', 'ELEGANCE', 'EMOTE', 'EMOTION', 'ENERGY', 'ENTERTAINMENT', 'EXERCISE', 'EXPERIMENTAL', 'EXPERTISE', 'EXPRESSIVE', 'EXTRAORDINARY', 'FACILITY', 'FANDANGO', 'FASHIONABLE', 'FEATURED', 'FLAMENCO', 'FLING', 'FLOOR', 'FORM', 'FORMAL', 'FOX TROT', 'FREE', 'FREQUENCY', 'FUNCTION', 'FUNDS', 'FUTURE', 'GARMENT', 'GAVOTTE', 'GESTURE', 'GLIDE', 'GRACE', 'GRANT', 'GROUPS', 'GYMNASIUM', 'HORA', 'HULA', 'IDEAL', 'IMITATION', 'IMPROVISE', 'INDIVIDUALITY', 'INFORMAL', 'INSPIRATION', 'INSPIRED BY', 'INTERPRET', 'INTERPRETATION', 'JAZZ', 'JIG', 'JITTERBUG', 'JOYFUL', 'JUMP', 'KIND', 'LEAP', 'LEOTARD', 'LIFT', 'LIGHT', 'LINE', 'MAJOR', 'MAKE UP', 'MAMBO', 'MASTERY', 'MAYPOLE', 'MAZURKA', 'MINOR', 'MINUET', 'MIX', 'MONEY', 'MOOD', 'MOTION', 'MOVEMENT', 'MOVIES', 'MUSIC', 'MUSICAL', 'MUSICALITY', 'NOVICE', 'NUMBERS', 'ORCHESTRA', 'ORGANIZED', 'ORIGINAL', 'PARTNER', 'PASSION', 'PATTERNS', 'PENCHANT', 'PERSON', 'PIECE', 'POLKA', 'PORTRAY', 'POSITION', 'POSTURE', 'POWERFUL', 'PRACTICE', 'PRECISION', 'PRESSURE', 'PRIMITIVE', 'PRODUCTION', 'PROGRAM', 'PROPORTION', 'PURPOSE', 'QUADRILLE', 'QUALITY', 'QUICK', 'RECREATION', 'REEL', 'REHEARSAL', 'REHEARSE', 'REVEL', 'REVELATION', 'RHYTHM', 'RISE', 'ROLE', 'ROTATION', 'SHUFFLE', 'SPACE', 'SPECTACLE', 'SPECTATOR', 'SPEED', 'STAR', 'STEPS', 'STRUT', 'STUDENT', 'STUDIO', 'STYLE', 'SUGGESTIVE', 'SUPPORT', 'SWAY', 'SWIRL', 'SYMBOLIC', 'TALENT', 'TANGO', 'TARANTELLA', 'TEACHING', 'TECHNICAL', 'TECHNIQUE', 'TEMPOS', 'THEATER', 'THEATRICAL', 'THEMES', 'THERAPY', 'TIME', 'TIMING', 'TOUR', 'TOURING', 'TRADITIONAL', 'TRIBUTE', 'TROUPE', 'TUCK', 'TWIRL', 'TWIST', 'TYPE', 'UNITARDS', 'UPRIGHT', 'VARIETY', 'VISUAL', 'WALTZ', 'WHIMSY', 'WIELD', 'ZEAL'],
         ...
         "vegetables": ['AFFECT', 'ARTICHOKE', 'ARUGULA', 'ASPARAGUS', 'AVOCADO', 'BEANS', 'BEETS', 'BLAND', 'BROCCOLI', 'BULBS', 'CARROT', 'CAULIFLOWER', 'CELERY', 'CHARD', 'CHICK PEAS', 'CHILDREN', 'CHIVES', 'CHOICES', 'CHOP', 'COLOR', 'COOKED', 'COOKING', 'CUCUMBER', 'CULINARY', 'DAILY', 'DELICIOUS', 'DISLIKE', 'DISTINCTIVE', 'DROUGHT', 'EATING', 'EDIBLE', 'EFFECT', 'EGGPLANT', 'ENDIVE', 'FARMER', 'FARMER', 'FENNEL', 'FERTILIZER', 'FOOD', 'GINGER', 'GREEN BEANS', 'GROCERY', 'GROWING', 'HERBACEOUS', 'IRRIGATION', 'ITEM', 'JUICE', 'KIDS', 'KINGDOM', 'KOHLRABI', 'LEAVES', 'LEEK', 'LENTILS', 'LETTUCE', 'LIKE', 'LIMA BEANS', 'MAIZE', 'MARKET', 'MEAL', 'MUSHROOM', 'MUSTARD GREENS', 'NATURAL', 'NATURE', 'NUTRITION', 'OKRA', 'OLIVES', 'ONION', 'PACKAGING', 'PALATE', 'PARSNIP', 'PEAS', 'PICKLES', 'PLANT', 'POTATO', 'PREFERENCE', 'PREPARATION', 'PRODUCE', 'PUMPKIN', '', 'RADICCHIO', 'RADISH', 'RAIN', 'RANCH', 'RAW', 'RUTABAGA', 'SALAD', 'SAVORY', 'SCALLIONS', 'SEASON', 'SEEDS', 'SELECTION', 'SLICE', 'SMELL', 'SOYBEANS', 'SPINACH', 'SPROUTS', 'SPUDS', 'SQUASH', 'STEM', 'STRING BEANS', 'SUCCOTASH', 'SWEET POTATO', 'TASTE', 'TOIL', 'TUBERS', 'TURNIP', 'VARIETY', 'VEGETARIAN', 'VEGGIES', 'VITAMINS', 'WATER', 'WATERCRESS', 'YAM', 'YUMMY', 'ZUCCHINI'],
         "cars": ['ACCESSORIES', 'ACTION', 'ALERT', 'ALTERNATIVES', 'ANTIQUE', 'APPEAL', 'AUTO', 'AUTOMAKER', 'BACK SEAT', 'BLOCK', 'BOLTS', 'BRAKES', 'BRANDS', 'BUFF', 'CAR', 'CAR FAX', 'CAR PORT', 'CARE', 'CAUTION', 'CERTIFIED', 'CHOICES', 'CHROME', 'CLASS', 'CLASSIC', 'CLIENT', 'COLOR', 'COMFORT', 'CONDITION', 'CONTROL', 'CONVERTIBLE', 'COST', 'COUPE', 'CREDIT SCORE', 'CROSSING', 'CUSTOM', 'CUSTOMER', 'DANGER', 'DASHBOARD', 'DEAL', 'DEALERSHIP', 'DELIVERY', 'DELIVERY', 'DENT', 'DESIGN', 'DETOUR', 'DRINKING', 'DRIVE', 'DRIVER', '', 'FEATURES', 'FOB', 'FOUR DOOR', 'FRONT SEAT', 'GARAGE', 'GASKET', 'GASOLINE', 'GAUGES', 'GEAR', 'GRAVEL', 'HI-TEST', 'HIGHWAY', 'HORN', 'INDICATOR', 'INFANT SEATS', 'INSURANCE', 'INSURED', 'INTERSTATE', 'INVOICE', 'JALOPY', 'JUDGMENT', 'KELLY BLUE BOOK', 'KEYS', 'KINDS', 'LANES', 'LAWS', 'LEATHER', 'LEFT', 'LESSONS', 'LICENSE', 'LIST PRICE', 'LOT', 'LOYALTY', 'MAKE', 'MANUFACTURE', 'MAPS', 'MECHANIC', 'MID-GRADE', 'MILEAGE', 'MILES', 'MIRROR', 'MODEL', 'MSR', 'NASCAR', 'NEW', 'OBEY', 'OBSTRUCTION', 'OIL', 'PARK', 'PASSENGER', 'PASSING', 'PEDALS',  'PISTON', 'POLISH', 'POWER', 'PRICE', 'PROBLEMS', 'PUMP', 'PURCHASE PRICE', 'QUALITY', 'QUICK', 'RACING', 'RECALL', 'REGULAR', 'REGULATIONS', 'REPAIR', 'RESTRICTION', 'RIGHT', 'RINGS', 'ROADWAY', 'ROD', 'SAFETY', 'SAFETY', 'SALESMAN', 'SALESWOMAN', 'SEAL', 'SEAT BELTS', 'SEDAN', 'SERVICE DEPARTMENT', 'SHIFT', 'SHOWROOM', 'SIGNAL', 'SIZE', 'SLOW', 'SPECIFICATIONS', 'SPEED LIMIT', 'SPIEL', 'START', 'STEER', 'STYLE', 'SUPREME', 'SURFACE', 'TEENS', 'TEST', 'TEXTING', 'TICKET', 'TIRES', 'TOURING', 'TURN', 'TYPES', 'USAGE', 'USED CAR', 'WAX', 'YEAR', 'ZIP']
         }
...
def reset():
    global guessed, word, topic, hangman_img_status, letters
    guessed.clear()
    topic = random.choice(topics)
    word = random.choice(words[topic])
    word = word.replace(' ', '')
...
def end_game_loop(win):
    ...
    while(run):
        ...
        window.blit(correct_text, (350, 385))
        # Play again button
